...
float KpL = 66;  // Proportional gain
float KiL = 178;  // Integral gain
float KdL = 12; // Derivative gain
// PID constants
float KpR = 173;  // Proportional gain
float KiR = 186;  // Integral gain
float KdR = 33;  // Derivative gain
