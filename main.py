...
def init_state():
    try:
        subprocess.run(["python3", "init_state.py"], check=True)
        print("init_state.py script has been executed successfully.")
    except subprocess.CalledProcessError as e:
        print(f"Error occurred while running init_state.py: {e}")
...
try:
    while True:
        ...
        if current_time - frame_last_processed_time >= 0.8:
            ...
            if current_state == State.START:
            ...
            elif current_state == State.FOLLOWGREEN:
                print("State: FOLLOW_GREEN")
                ...
                if contours:
                    ...
                    transition(State.PATH_PLANNING)
